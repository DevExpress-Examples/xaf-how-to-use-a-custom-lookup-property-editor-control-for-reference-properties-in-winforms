...
Namespace Editors.Win
    ...
    Public Class LookUpEditEx
        ...
        Private ReadOnly Property IGridInplaceEdit_DataBindings() As System.Windows.Forms.ControlBindingsCollection Implements IGridInplaceEdit.DataBindings
            Get
                Return MyBase.DataBindings
            End Get
        End Property
        Private Property IGridInplaceEdit_GridEditingObject() As Object Implements IGridInplaceEdit.GridEditingObject
            Get
